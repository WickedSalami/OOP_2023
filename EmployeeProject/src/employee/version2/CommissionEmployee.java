...
public class CommissionEmployee extends Employee{
    ...
    // Default Constructor
    public CommissionEmployee(int empID, String empName, employee.version3.DateFormat empDateHired, employee.version3.DateFormat empBirthDate, Double totalSales) {
    }
    ...
    // Full constructor
    public CommissionEmployee(int empID, String empName, DateFormat empDateHired, DateFormat empBirthDate, Double totalSales) {
